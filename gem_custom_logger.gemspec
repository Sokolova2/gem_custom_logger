...
Gem::Specification.new do |spec|
  ...
  spec.metadata['allowed_push_host'] = 'https://github.com/Sokolova2/gem_custom_logger'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/Sokolova2/gem_custom_logger'
  spec.metadata['changelog_uri'] = 'https://github.com/Sokolova2/gem_custom_logger/blob/main/CHANGELOG.md'
